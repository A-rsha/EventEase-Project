        ...
        <div className="min-h-screen text-white">
            ...
            <section className="py-20 px-6">
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-6 text-center hover:scale-105 transition">
            ...
            <section className="py-20 text-center">
                ...
                <button
                    onClick={() => navigate("/")}
                    className="bg-purple-600 hover:bg-pink-500 px-8 py-3 rounded-full font-semibold transition"
                >
                    Get Started
                </button>
            </section>
